      ...
      <div className="what-box">
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                fundamentals, Neural Networks, and Python-based AI tools.
                Passionate about data logic and intelligent automation.
              </p>
              ...
              <div className="what-content-flex">
                ...
                <div className="what-tags">Data Logic</div>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DEVELOPMENT</h3>
              <h4>Building Software Solutions</h4>
              <p>
                Creating applications using Python and C programming. From
                calculators to grade systems, I build practical tools that solve
                real problems.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
